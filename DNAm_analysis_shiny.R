...
server <- function(input,output,session) {
  ...
  #cpg_positions input
  observe({  
    rootsV <- c(DNAm_scripts_directory = file.path(dirScript, "DNAm_report", "annot_rds_files"), 
                user_current_directory = userCurrentDir, 
                home = '~', volumes())
  ...
  observeEvent(input$generateReport, {
    ...
    # render(input = "/Users/alexishardy/Desktop/MD_Lab/DNAm_visualization_project/DNAm_visualization_report_v5.Rmd")
    
    # system("Rscript /Users/alexishardy/Desktop/MD_Lab/DNAm_visualization_project/DNAm_report_script_v2.R", wait = FALSE)
    
    # system("Rscript /Users/alexishardy/Desktop/MD_Lab/DNAm_visualization_project/DNAm_report_script_v2.R", wait = TRUE)
    
    
    
    
    # stopApp("Rscript /Users/alexishardy/Desktop/MD_Lab/DNAm_visualization_project/DNAm_report_script_v2.R")
    
    # stopApp(paste0('"', value_samples_path(), '"'))
    
    
    # stopApp(
    #   paste(
    #     'Rscript /Users/alexishardy/Desktop/MD_Lab/DNAm_visualization_project/DNAm_report_script_v3.R',
    #     '-sp', paste0('"',value_samples_path(),'"'),
    #     '-sitc', paste0('"',input$samples_id_to_check,'"'),
    #     '-cpath', paste0('"',value_control_path(),'"'),
    #     '-cpos', paste0('"',value_cpg_positions(),'"'),
    #     '-rp', paste0('"',value_regions_path(),'"'),
    #     '-rgtc', paste0('"',input$regions_group_to_check,'"'),
    #     '-rs', paste0('"',input$regions_status,'"'),
    #     '-gac', paste0('"',input$group_as_ctrls,'"'),
    #     '-etg', paste0('"',input$export_tables_graphs,'"'),
    #     sep = " "
    #     ))
    ...
    commandToExport(
      paste(
        paste0('Rscript ', dirScript,'/DNAm_report/DNAm_report_script.R'),
        cond1, cond2, cond3,
        cond4, cond5, cond6,
        cond7, cond8, cond9,
        cond10,
    ...
    #   stopApp(
    #     paste(
    #       paste0('Rscript ', dirScript,'/DNAm_report_script_v3.R'),
    #       cond1, cond2, cond3,
    #       cond4, cond5, cond6,
    #       cond7, cond8, cond9,
    #       cond10,
